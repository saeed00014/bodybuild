...
const CardComponent = () => {
  ...
  useEffect(() => {
    const handleget = async () => {
      const res = await fetch('https://bodybuild-api.cyclic.app/card', {
        method: 'GET',
        headers: {
  ...
  const handleDelete = async (product) => {
    await fetch('https://bodybuild-api.cyclic.app/card' + product._id, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        'Accept': 'application/json',
  ...
  const handleAdd = async (product) => {
    if(product.quantity < 5) {
      await fetch('https://bodybuild-api.cyclic.app/card', {
        method: 'POST',
